...
print (f"Account: {format(acc_num1, '07d')} Name: {format(name1, '<15s')} Balance: {format(format(balance1, '6.2f'), '7s')}") 
print (f"Account: {format(acc_num2, '07d')} Name: {format(name2, '<15s')} Balance: {format(format(balance2, '6.2f'), '7s')}") 
print (f"Account: {format(acc_num3, '07d')} Name: {format(name3, '<15s')} Balance: {format(format(balance3, '6.2f'), '7s')}") 
